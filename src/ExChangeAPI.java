...
public class ExChangeAPI {
    ...
    private  String tame_last_update_utc;
    private int time_next_update_unix;
    private String time_next_update_utc;
    private String base_code;
    private JSONObject eachRate;

    private static String url_API = "https://v6.exchangerate-api.com/v6/dc4fa5416ca35b4e14206bc1/latest/";
    private static JSONObject jsonObject;

    //connect to sever
    public boolean getConnection(String base_code){0
        String json = "";
        URL url = null;
